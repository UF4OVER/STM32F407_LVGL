...
void INA226_Voltage_Current_Power(float *volt, float *current, float *power)
{
    ...
    *current = INA226_values.Current * INA226_values.CurrentLSB;
    *power   = INA226_values.Power * INA226_values.CurrentLSB * 25;
...
void INA226_I2C_ReadBuff(uint8_t pByte, uint8_t* pData, uint16_t size)
{
    HAL_I2C_Mem_Read(&hi2c1, INA226_ADDRESS << 1, pByte, 1, pData, size, 100);
}
