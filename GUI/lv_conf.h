...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(blender16) LV_FONT_DECLARE(blender20) LV_FONT_DECLARE(blender24) LV_FONT_DECLARE(blender28) LV_FONT_DECLARE(blender34)                                                  \
