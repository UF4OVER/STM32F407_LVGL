...
void setup_scr_SEETING(lv_ui *ui)
{
	...
	lv_obj_set_style_bg_color(ui->SEETING, lv_color_hex(0x8e8e8e), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_color(ui->SEETING_BACK_BTN, lv_color_hex(0x303030), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->SEETING_BACK_BTN, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_color(ui->SEETING_SET_MEUN, lv_color_hex(0x8e8e8e), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_style_set_bg_color(&style_SEETING_SET_MEUN_extra_sidebar_page_main_default, lv_color_hex(0xdaf2f8));
	...
	lv_style_set_text_color(&style_SEETING_SET_MEUN_extra_option_btns_main_default, lv_color_hex(0x151212));
	lv_style_set_text_font(&style_SEETING_SET_MEUN_extra_option_btns_main_default, &lv_font_montserratMedium_12);
	...
	lv_style_set_text_color(&style_SEETING_SET_MEUN_extra_option_btns_main_checked, lv_color_hex(0x9ab700));
	lv_style_set_text_font(&style_SEETING_SET_MEUN_extra_option_btns_main_checked, &lv_font_montserratMedium_12);
	lv_style_set_text_align(&style_SEETING_SET_MEUN_extra_option_btns_main_checked, LV_TEXT_ALIGN_CENTER);
	lv_style_set_border_width(&style_SEETING_SET_MEUN_extra_option_btns_main_checked, 0);
	lv_style_set_radius(&style_SEETING_SET_MEUN_extra_option_btns_main_checked, 0);
	lv_style_set_bg_opa(&style_SEETING_SET_MEUN_extra_option_btns_main_checked, 60);
	lv_style_set_bg_color(&style_SEETING_SET_MEUN_extra_option_btns_main_checked, lv_color_hex(0x00e0b8));
	...
	lv_style_set_text_color(&style_SEETING_SET_MEUN_extra_main_title_main_default, lv_color_hex(0x41485a));
	lv_style_set_text_font(&style_SEETING_SET_MEUN_extra_main_title_main_default, &lv_font_montserratMedium_12);
	...
	lv_style_set_bg_color(&style_SEETING_SET_MEUN_extra_main_title_main_default, lv_color_hex(0xffffff));
