...
# Create START_img_1
START_img_1 = lv.img(START)
START_img_1.set_src(load_image(r"E:\lvgl_project\LM32\generated\MicroPython\4b2557acd3a9c3c4c0847bc3d36e804_450_150.png"))
START_img_1.add_flag(lv.obj.FLAG.CLICKABLE)
START_img_1.set_pivot(50,50)
START_img_1.set_angle(0)
START_img_1.set_pos(15, 49)
START_img_1.set_size(450, 150)
START_img_1.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
#Update pos for widget START_img_1
START_img_1.update_layout()
#Write animation: START_img_1 move in x direction
START_img_1_x = lv.anim_t()
START_img_1_x.init()
START_img_1_x.set_var(START_img_1)
START_img_1_x.set_time(1000)
START_img_1_x.set_custom_exec_cb(lambda e,val: anim_x_cb(START_img_1,val))
START_img_1_x.set_values(START_img_1.get_x(), 15)
START_img_1_x.set_path_cb(lv.anim_t.path_linear)
START_img_1_x.start()
#Write animation: START_img_1 move in y direction
START_img_1_y = lv.anim_t()
START_img_1_y.set_var(START_img_1)
START_img_1_y.set_time(1000)
START_img_1_y.set_custom_exec_cb(lambda e,val: anim_y_cb(START_img_1,val))
START_img_1_y.set_values(START_img_1.get_y(), 200)
START_img_1_y.set_path_cb(lv.anim_t.path_linear)
START_img_1_y.start()
# Set style for START_img_1, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
START_img_1.set_style_img_opa(255, lv.PART.MAIN|lv.STATE.DEFAULT)

# Create START_start_label
START_start_label = lv.label(START)
START_start_label.set_text("The Device is Collecting Hardware Packets....")
START_start_label.set_long_mode(lv.label.LONG.WRAP)
START_start_label.set_pos(31, 216)
START_start_label.set_size(419, 32)
START_start_label.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
# Set style for START_start_label, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
START_start_label.set_style_border_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_radius(3, lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_text_color(lv.color_hex(0x000000), lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_text_font(test_font("blender_pro_bold", 18), lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_text_letter_space(2, lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_text_line_space(0, lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_text_align(lv.TEXT_ALIGN.CENTER, lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_bg_opa(255, lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_bg_color(lv.color_hex(0xa1511c), lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_pad_top(6, lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_pad_right(0, lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_pad_bottom(0, lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_pad_left(0, lv.PART.MAIN|lv.STATE.DEFAULT)
START_start_label.set_style_shadow_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)
...
# Create SEETING
SEETING = lv.obj()
SEETING.set_size(480, 320)
SEETING.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
# Set style for SEETING, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
SEETING.set_style_bg_opa(255, lv.PART.MAIN|lv.STATE.DEFAULT)
SEETING.set_style_bg_color(lv.color_hex(0x8e8e8e), lv.PART.MAIN|lv.STATE.DEFAULT)

# Create SEETING_SET_MEUN
SEETING_SET_MEUN = lv.menu(SEETING)
SEETING_SET_MEUN_sidebar_page = lv.menu_page(SEETING_SET_MEUN, "SETTING")
SEETING_SET_MEUN.set_sidebar_page(SEETING_SET_MEUN_sidebar_page)
SEETING_SET_MEUN_subpage_0 = lv.menu_page(SEETING_SET_MEUN, None)
SEETING_SET_MEUN_cont_0 = lv.menu_cont(SEETING_SET_MEUN_sidebar_page)
SEETING_SET_MEUN_label_0 = lv.label(SEETING_SET_MEUN_cont_0)
SEETING_SET_MEUN_label_0.set_text("BLE&WIFI")
SEETING_SET_MEUN_label_0.set_size(lv.pct(100), lv.SIZE.CONTENT)
SEETING_SET_MEUN.set_load_page_event(SEETING_SET_MEUN_cont_0, SEETING_SET_MEUN_subpage_0)
SEETING_SET_MEUN_subpage_1 = lv.menu_page(SEETING_SET_MEUN, None)
SEETING_SET_MEUN_cont_1 = lv.menu_cont(SEETING_SET_MEUN_sidebar_page)
SEETING_SET_MEUN_label_1 = lv.label(SEETING_SET_MEUN_cont_1)
SEETING_SET_MEUN_label_1.set_text("DEVICE&INFO")
SEETING_SET_MEUN_label_1.set_size(lv.pct(100), lv.SIZE.CONTENT)
SEETING_SET_MEUN.set_load_page_event(SEETING_SET_MEUN_cont_1, SEETING_SET_MEUN_subpage_1)
SEETING_SET_MEUN_subpage_2 = lv.menu_page(SEETING_SET_MEUN, None)
SEETING_SET_MEUN_cont_2 = lv.menu_cont(SEETING_SET_MEUN_sidebar_page)
SEETING_SET_MEUN_label_2 = lv.label(SEETING_SET_MEUN_cont_2)
SEETING_SET_MEUN_label_2.set_text("THEMES")
SEETING_SET_MEUN_label_2.set_size(lv.pct(100), lv.SIZE.CONTENT)
SEETING_SET_MEUN.set_load_page_event(SEETING_SET_MEUN_cont_2, SEETING_SET_MEUN_subpage_2)
SEETING_SET_MEUN_subpage_3 = lv.menu_page(SEETING_SET_MEUN, None)
SEETING_SET_MEUN_cont_3 = lv.menu_cont(SEETING_SET_MEUN_sidebar_page)
SEETING_SET_MEUN_label_3 = lv.label(SEETING_SET_MEUN_cont_3)
SEETING_SET_MEUN_label_3.set_text("PID&INFO")
SEETING_SET_MEUN_label_3.set_size(lv.pct(100), lv.SIZE.CONTENT)
SEETING_SET_MEUN.set_load_page_event(SEETING_SET_MEUN_cont_3, SEETING_SET_MEUN_subpage_3)
SEETING_SET_MEUN_subpage_4 = lv.menu_page(SEETING_SET_MEUN, None)
SEETING_SET_MEUN_cont_4 = lv.menu_cont(SEETING_SET_MEUN_sidebar_page)
SEETING_SET_MEUN_label_4 = lv.label(SEETING_SET_MEUN_cont_4)
SEETING_SET_MEUN_label_4.set_text("BOOTVERSION")
SEETING_SET_MEUN_label_4.set_size(lv.pct(100), lv.SIZE.CONTENT)
SEETING_SET_MEUN.set_load_page_event(SEETING_SET_MEUN_cont_4, SEETING_SET_MEUN_subpage_4)
SEETING_SET_MEUN.set_pos(0, 0)
SEETING_SET_MEUN.set_size(480, 320)
SEETING_SET_MEUN.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
# Set style for SEETING_SET_MEUN, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
SEETING_SET_MEUN.set_style_bg_opa(255, lv.PART.MAIN|lv.STATE.DEFAULT)
SEETING_SET_MEUN.set_style_bg_color(lv.color_hex(0x8e8e8e), lv.PART.MAIN|lv.STATE.DEFAULT)
SEETING_SET_MEUN.set_style_radius(0, lv.PART.MAIN|lv.STATE.DEFAULT)
SEETING_SET_MEUN.set_style_shadow_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)
# Set style for SEETING_SET_MEUN, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
style_SEETING_SET_MEUN_extra_sidebar_page_main_default = lv.style_t()
style_SEETING_SET_MEUN_extra_sidebar_page_main_default.init()
style_SEETING_SET_MEUN_extra_sidebar_page_main_default.set_bg_opa(255)
style_SEETING_SET_MEUN_extra_sidebar_page_main_default.set_bg_color(lv.color_hex(0xdaf2f8))
style_SEETING_SET_MEUN_extra_sidebar_page_main_default.set_radius(0)
SEETING_SET_MEUN_sidebar_page.add_style(style_SEETING_SET_MEUN_extra_sidebar_page_main_default, lv.PART.MAIN|lv.STATE.DEFAULT)
# Set style for SEETING_SET_MEUN, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
style_SEETING_SET_MEUN_extra_option_btns_main_default = lv.style_t()
style_SEETING_SET_MEUN_extra_option_btns_main_default.init()
style_SEETING_SET_MEUN_extra_option_btns_main_default.set_text_color(lv.color_hex(0x151212))
style_SEETING_SET_MEUN_extra_option_btns_main_default.set_text_font(test_font("montserratMedium", 12))
style_SEETING_SET_MEUN_extra_option_btns_main_default.set_text_align(lv.TEXT_ALIGN.CENTER)
style_SEETING_SET_MEUN_extra_option_btns_main_default.set_pad_top(10)
style_SEETING_SET_MEUN_extra_option_btns_main_default.set_pad_bottom(10)
SEETING_SET_MEUN_cont_0.add_style(style_SEETING_SET_MEUN_extra_option_btns_main_default, lv.PART.MAIN|lv.STATE.DEFAULT)
SEETING_SET_MEUN_cont_1.add_style(style_SEETING_SET_MEUN_extra_option_btns_main_default, lv.PART.MAIN|lv.STATE.DEFAULT)
SEETING_SET_MEUN_cont_2.add_style(style_SEETING_SET_MEUN_extra_option_btns_main_default, lv.PART.MAIN|lv.STATE.DEFAULT)
SEETING_SET_MEUN_cont_3.add_style(style_SEETING_SET_MEUN_extra_option_btns_main_default, lv.PART.MAIN|lv.STATE.DEFAULT)
SEETING_SET_MEUN_cont_4.add_style(style_SEETING_SET_MEUN_extra_option_btns_main_default, lv.PART.MAIN|lv.STATE.DEFAULT)
# Set style for SEETING_SET_MEUN, Part: lv.PART.MAIN, State: lv.STATE.CHECKED.
style_SEETING_SET_MEUN_extra_option_btns_main_checked = lv.style_t()
style_SEETING_SET_MEUN_extra_option_btns_main_checked.init()
style_SEETING_SET_MEUN_extra_option_btns_main_checked.set_text_color(lv.color_hex(0x9ab700))
style_SEETING_SET_MEUN_extra_option_btns_main_checked.set_text_font(test_font("montserratMedium", 12))
style_SEETING_SET_MEUN_extra_option_btns_main_checked.set_text_align(lv.TEXT_ALIGN.CENTER)
style_SEETING_SET_MEUN_extra_option_btns_main_checked.set_border_width(0)
style_SEETING_SET_MEUN_extra_option_btns_main_checked.set_radius(0)
style_SEETING_SET_MEUN_extra_option_btns_main_checked.set_bg_opa(60)
style_SEETING_SET_MEUN_extra_option_btns_main_checked.set_bg_color(lv.color_hex(0x00e0b8))
SEETING_SET_MEUN_cont_0.add_style(style_SEETING_SET_MEUN_extra_option_btns_main_checked, lv.PART.MAIN|lv.STATE.CHECKED)
SEETING_SET_MEUN_cont_1.add_style(style_SEETING_SET_MEUN_extra_option_btns_main_checked, lv.PART.MAIN|lv.STATE.CHECKED)
SEETING_SET_MEUN_cont_2.add_style(style_SEETING_SET_MEUN_extra_option_btns_main_checked, lv.PART.MAIN|lv.STATE.CHECKED)
SEETING_SET_MEUN_cont_3.add_style(style_SEETING_SET_MEUN_extra_option_btns_main_checked, lv.PART.MAIN|lv.STATE.CHECKED)
SEETING_SET_MEUN_cont_4.add_style(style_SEETING_SET_MEUN_extra_option_btns_main_checked, lv.PART.MAIN|lv.STATE.CHECKED)
# Set style for SEETING_SET_MEUN, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
style_SEETING_SET_MEUN_extra_main_title_main_default = lv.style_t()
style_SEETING_SET_MEUN_extra_main_title_main_default.init()
style_SEETING_SET_MEUN_extra_main_title_main_default.set_text_color(lv.color_hex(0x41485a))
style_SEETING_SET_MEUN_extra_main_title_main_default.set_text_font(test_font("montserratMedium", 12))
style_SEETING_SET_MEUN_extra_main_title_main_default.set_text_align(lv.TEXT_ALIGN.CENTER)
style_SEETING_SET_MEUN_extra_main_title_main_default.set_bg_opa(255)
style_SEETING_SET_MEUN_extra_main_title_main_default.set_bg_color(lv.color_hex(0xffffff))
style_SEETING_SET_MEUN_extra_main_title_main_default.set_pad_top(0)
style_SEETING_SET_MEUN_extra_main_title_main_default.set_pad_bottom(0)
SEETING_SET_MEUN_title = SEETING_SET_MEUN.get_child(0)
SEETING_SET_MEUN_title.set_size(lv.pct(100), lv.SIZE.CONTENT)
SEETING_SET_MEUN.get_sidebar_header().add_style(style_SEETING_SET_MEUN_extra_main_title_main_default, lv.PART.MAIN|lv.STATE.DEFAULT)

SEETING.update_layout()
